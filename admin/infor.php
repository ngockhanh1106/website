...
<div class="col-md-12 " style="width:100%;">
    <div class="text-bold" active="activeForm">
        ...
        <div class="tab-content py-2">
            <div class="tab-pane active portlet" ng-repeat="tab in tabset.tabs" ng-class="{active: tabset.active === tab.index}" uib-tab-content-transclude="tab">
                    ...
                    <div class="panel-body">
                        <div class="row form-group p-3">
                            <div class="col-xs-6 col-md-2">
                                <img height="160" width="130" alt="" src="../image/">
                            </div>
                            <div class="col-md-10">
